...
router.addDefaultHandler(
    ...
    {
        // Set the request timeout to 30 minutes (1,800,000 milliseconds)
        requestTimeout: 1800000, // 30 minutes in milliseconds
        // Optional: increase the number of retries if needed
        maxRequestRetries: 5, // or whatever fits your scenario
    }
);
